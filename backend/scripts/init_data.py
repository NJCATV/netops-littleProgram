...
DEFAULT_MENUS = [
    ...
    ("netops.dashboard", "网络总览", "dashboard", "/pages/netops/dashboard/index", "网管", "normal_user", 30),
    ("netops.quality", "质差管理", "quality", "/pages/netops/quality/index", "网管", "normal_user", 40),
    ("netops.performance", "OLT性能", "performance", "/pages/netops/performance/index", "网管", "normal_user", 50),
    ("netops.collector", "采集监控", "collector", "/pages/netops/collector/index", "网管", "normal_user", 60),
    ("netops.devices", "OLT设备", "olt", "/pages/netops/devices/index", "网管", "normal_user", 70),
    ("netops.boss-users", "BOSS用户", "customer", "/pages/netops/boss-users/index", "网管", "super_admin", 80),
    ("netops.admin", "网管配置", "organization", "/pages/netops/admin/index", "网管", "org_admin", 90),
