...
const MESSAGE_LABELS = {
  ...
  'too many failed attempts, try again in 15 minutes': '登录失败次数过多，请 15 分钟后再试',
  ...
  'path is required': '请填写页面路径',
  'protected menu cannot be deleted': '权限配置入口不能删除',
  'protected menu cannot be disabled': '权限配置入口不能禁用',
  'protected menu cannot be changed': '权限配置入口的编码和启用状态不能修改',
  ...
  'avatar must be square': '请将头像裁切为正方形',
